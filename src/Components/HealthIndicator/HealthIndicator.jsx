  ...
  render() {
    return (
      <div className={styles.HealthIndicatorContainer}>
        <div className={styles.iconContainer} style={{ backgroundColor: `${this.props.color}`}}>{this.props.icon}</div>
        <div className={styles.indicatorContent}>
          <div className={styles.indicatorNumber}>{this.props.indicatorNumber}</div>
